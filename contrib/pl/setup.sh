...
ssh -i ${root_dir}/.ssh/id_rsa_cloud -o StrictHostKeyChecking=no -t -t $workload_user@$peer "sh /home/${workload_user}/tejo/tejo/common/experiments_scripts/ycsb/run.sh 0 $workload_throughput &"
echo "done"