...
\input{inputs/sections/background.tex}
\input{inputs/sections/design.tex}
\input{inputs/sections/setup.tex}
\input{inputs/sections/experiment.tex}
\input{inputs/sections/results.tex}
\input{inputs/sections/discussion.tex}
\input{inputs/sections/conclusion.tex}

%\input{inputs/sections/introduction}
